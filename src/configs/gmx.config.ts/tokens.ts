...
import { ARBITRUM, ARBITRUM_GOERLI, AVALANCHE, AVALANCHE_FUJI } from "../../constants/chains";
...
export const TOKENS: { [chainId: number]: Token[] } = {
    ...
    },
    {
        name: "GMX",
        symbol: "GMX",
        address: getContractAddress(ARBITRUM, "GMX"),
        decimals: 18,
    ...
    },
    {
        name: "Escrowed GMX",
        symbol: "esGMX",
        address: getContractAddress(ARBITRUM, "ES_GMX"),
        decimals: 18,
        isPlatformToken: true,
    },
    {
        name: "GMX LP",
        symbol: "GLP",
        address: getContractAddress(ARBITRUM, "GLP"),
        decimals: 18,
    ...
    },
    {
        name: "GMX",
        symbol: "GMX",
        address: getContractAddress(AVALANCHE, "GMX"),
        decimals: 18,
        imageUrl: "https://assets.coingecko.com/coins/images/18323/small/arbit.png?1631532468",
        isPlatformToken: true,
        coingeckoUrl: "https://www.coingecko.com/en/coins/gmx",
    ...
    },
    {
        name: "Escrowed GMX",
        symbol: "esGMX",
        address: getContractAddress(AVALANCHE, "ES_GMX"),
        decimals: 18,
        isPlatformToken: true,
    },
    {
        name: "GMX LP",
        symbol: "GLP",
        address: getContractAddress(AVALANCHE, "GLP"),
        decimals: 18,
        isPlatformToken: true,
        imageUrl: "https://github.com/gmx-io/gmx-assets/blob/main/GMX-Assets/PNG/GLP_LOGO%20ONLY.png?raw=true",
